...
//		cancelScanButton = (Button) this.findViewById(R.id.btn_cancel_scan);
    ...
    public Result scanningImage(Uri uri) {
        ...
        if (scanBitmap == null) {
            Log.w(TAG, "Unable to decode selected image");
            return null;
        }
        ...
        try {
            ...
            Log.w(TAG, "QR code not found in selected image");
        } catch (ChecksumException e) {
            Log.w(TAG, "QR code checksum failed", e);
        } catch (FormatException e) {
            Log.w(TAG, "QR code format is invalid", e);
        }
        return null;
    }
    ...
    private View.OnClickListener flashListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            try {
                ...
                Log.w(TAG, "Unable to toggle flash", e);
            }
        }
    };
}
