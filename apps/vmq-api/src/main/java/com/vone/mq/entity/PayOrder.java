...
@Table(uniqueConstraints = {
        @UniqueConstraint(name = "uk_pay_order_order_id", columnNames = "order_id"),
        @UniqueConstraint(name = "uk_pay_order_pay_id", columnNames = "pay_id")
})
public class PayOrder {
    ...
    public void setReallyPrice(double reallyPrice) {
        this.reallyPrice = BigDecimal.valueOf(reallyPrice);
    }
